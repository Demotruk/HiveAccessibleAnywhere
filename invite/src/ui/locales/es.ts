...
export const t = {
  ...
  profile_desc: 'Agrega una foto y algunos detalles sobre ti.',
  profile_photo_btn: 'Agregar Foto',
  profile_photo_change: 'Cambiar Foto',
  profile_display_name: 'Nombre',
  profile_display_name_placeholder: 'Tu nombre',
  profile_about: 'Acerca de',
  profile_about_placeholder: 'Una breve biograf\u00eda (opcional)',
  profile_location: 'Ubicaci\u00f3n',
  profile_location_placeholder: '\u00bfD\u00f3nde est\u00e1s? (opcional)',
  profile_website: 'Sitio web',
  profile_website_placeholder: 'https:// (opcional)',
  profile_continue: 'Continuar',
  profile_uploading: 'Subiendo foto...',
  profile_saving: 'Guardando perfil...',
  profile_upload_failed: 'La subida de la foto fall\u00f3. Int\u00e9ntalo de nuevo.',
  profile_save_failed: 'No se pudo guardar el perfil. Int\u00e9ntalo de nuevo.',
  profile_name_required: 'El nombre es obligatorio.',
  profile_photo_required: 'Se requiere una foto.',

  // Introduction Post
  intro_title: 'Pres\u00e9ntate',
  intro_desc: 'Escribe una breve presentaci\u00f3n para la comunidad de Hive.',
  intro_post_title: 'T\u00edtulo del Post',
  intro_default_title: '\u00a1Hola Hive!',
  intro_about_me: 'Sobre M\u00ed',
  intro_about_me_placeholder: 'Cu\u00e9ntale a la comunidad un poco sobre ti...',
  intro_interests: '\u00bfQu\u00e9 te interesa?',
  intro_interests_placeholder: '\u00bfQu\u00e9 quieres explorar en Hive? (opcional)',
  intro_thank_you: 'Agradecimiento',
  intro_default_thanks: '\u00a1Gracias a @%1 por invitarme a Hive!',
  intro_publish: 'Publicar',
  intro_publishing: 'Publicando tu post...',
  intro_publish_failed: 'No se pudo publicar tu post. Int\u00e9ntalo de nuevo.',
  intro_about_required: 'Por favor escribe algo sobre ti.',
